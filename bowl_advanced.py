...
config_name = 'empty_scene' # 'empty_scene'
    ...
    'empty_scene': {
        ...
        'scene': {
         ...
         'white-bsdf': {
                'type': 'diffuse',
                'id': 'white-bsdf',
                'reflectance': { 'type': 'rgb', 'value': (0.50820166, 0.55280465,0.5267825) },
                #'reflectance': { 'type': 'rgb', 'value': (0.9, 0.955280465,0.95267825) },
            },
            'grey-bsdf': {
                'type': 'diffuse',
                'id': 'grey-bsdf',
                #'reflectance': { 'type': 'rgb', 'value': (0.9, 0.9522280465,0.9267825) },
                'reflectance': { 'type': 'rgb', 'value': (0.17584373, 0.19158818, 0.20427553) },
            },

            'cloth-bsdf': {
                'type': 'diffuse',
                'id': 'cloth-bsdf',
                #'reflectance': { 'type': 'rgb', 'value': (0.9, 0.93280465,0.9547825) },
                'reflectance': { 'type': 'rgb', 'value': (0.95557326, 0.84984094, 0.5667325) },
            },
        ...
        'scene': {
           ...
           # 'sensor': sensor,
            ...
            'white-bsdf': {
                'type': 'diffuse',
                'id': 'white-bsdf',
                'reflectance': { 'type': 'rgb', 'value': (0.5454028, 0.53961444, 0.47779614) },
            },
            'grey-bsdf': {
                'type': 'diffuse',
                'id': 'grey-bsdf',
                'reflectance': { 'type': 'rgb', 'value': (0.23835674, 0.22228305, 0.20795235) },
            },

            'cloth-bsdf': {
                'type': 'diffuse',
                'id': 'cloth-bsdf',
                'reflectance': { 'type': 'rgb', 'value': (1.0, 0.9064942, 0.61246735) },
            },
            ...
            'glass_bowl_bottom': {
                ...
                'interior': {
                    'type': 'homogeneous',
                    'scale': 1,
                    'sigma_t': {'type' : 'rgb', 'value' : [0.99, 0.99, 0.51]},
                    'albedo': {
                        'type': 'rgb',
                        'value' : [0.0, 0.0, 0.0]
            ...
            'glass_bowl_top': {
                ...
                'interior': {
                    'type': 'homogeneous',
                    'scale': 1,
                    'sigma_t': { 'type' : 'rgb', 'value': [0.991, 0.992, 0.52] },
                    'albedo': {
                        'type': 'rgb',
                        'value':[0.0, 0.0, 0.0]
                    },
...
for it in range(iterations):
    ...
    if it % 20 == 0:
        ...
        mi.util.write_bitmap(f"final_empty_optimized_{it:04d}.png", image)
        for k in keys:
            print(f"    {k}: {params[k]}")
